...
class Stock(models.Model):
    symbol = models.CharField(max_length=5, primary_key=True, default="NA")
    ...
    share_volume = models.FloatField(null=True)
    ...
    pe = models.DecimalField(null=True, max_digits=7, decimal_places=2)
    forward_pe = models.DecimalField(null=True, max_digits=7, decimal_places=2)
    eps = models.DecimalField(null=True, max_digits=7, decimal_places=2)
    ...
    current_yield = models.DecimalField(null=True, max_digits=7, decimal_places=2)
    beta = models.DecimalField(null=True, max_digits=7, decimal_places=2)
